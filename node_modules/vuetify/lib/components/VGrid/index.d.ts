...
declare const VContainer: {
    new (...args: any[]): {
        ...
        } & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps, "tag" | "fluid">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
declare const VCol: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "v-slot:default"?: false | (() => vue.VNodeChild) | undefined;
        } & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps, "offset" | "alignSelf" | "order" | "tag" | "cols">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
declare const VRow: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "v-slot:default"?: false | (() => vue.VNodeChild) | undefined;
        } & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps, "alignContent" | "tag" | "dense" | "justify" | "align" | "noGutters">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
