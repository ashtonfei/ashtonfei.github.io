...
const form = ref(null);
const bgColor = null; // ref(colors.grey.lighten4);
...
const submit = async () => {
	const title = "Code Support Request";
				...
				>
					<v-card>
						<v-card-text>
							...
							<small
								>Thanks for using this form. You will be
								notified with an email and I will review your
								request as soon as I can.</small
							>
						</v-card-text>
					</v-card>
				</v-form>
